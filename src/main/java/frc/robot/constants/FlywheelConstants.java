...
public final class FlywheelConstants {
    ...
    public static final int FOLLOWER1_MOTOR_ID = 8;
    public static final int FOLLOWER2_MOTOR_ID = 10;
    
    // Mechanical Configuration
    public static final double GEAR_RATIO = 1.0; // 1:1 ratio - Direct drive
    ...
    public static final double MAX_VELOCITY_RPS = 120.0; // ~7200 RPM (direct drive)
    public static final double VELOCITY_TOLERANCE_RPS = 2.0; // Within 2 RPS of target
    
    // PID Constants (velocity control)
    public static final double kP = 0.2; // Proportional gain - tuned for stable velocity control
